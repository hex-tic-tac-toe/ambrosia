    ...
    port: 1025, routes: {
        ...
        '/sets/:x/:o': async (req) => {
            ...
            for (const round of rounds) {
                ...
                htm += `<div style='background-color: ${color}22; display: inline-block; width: 100px; height: 100px; border-radius: 5px; margin: 5px; text-align: center;'><a style='color: ${mirage.terminal.white.hex()}; text-decoration: none;' href='/sets/${x}/${o}/${round}'>${+round + 1}</a></div>`;
